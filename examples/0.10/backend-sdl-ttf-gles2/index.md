---
layout: page
title: "Example: SDL_TTF_GLES2 backend"
breadcrumb: "sdl_ttf_gles2 backend"
---

The code below shows the template that is used for the other examples when using the SDL\_TTF\_GLES2 backend.
...
More information about the minimal code can be found in the [SDL_TTF_GLES2 backend tutorial](/tutorials/0.10/backend-sdl-ttf-gles2/).
