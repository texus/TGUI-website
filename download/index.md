...
<p>
  ...
  {% include button.ext text="Visual Studio - SFML_GRAPHICS - 32bit" link="https://github.com/texus/TGUI/releases/download/nightly_build/TGUI-1.x-nightly-VisualStudio-32bit-for-SFML-3.1.0.zip" style="Orange" %}
  {% include button.ext text="Visual Studio - SFML_GRAPHICS - 64bit" link="https://github.com/texus/TGUI/releases/download/nightly_build/TGUI-1.x-nightly-VisualStudio-64bit-for-SFML-3.1.0.zip" style="Orange" %} (use with <a href="https://www.sfml-dev.org/download/sfml/3.1.0/">SFML 3.1.0</a> binaries)<br>
</p>
...
{% include button.ext text="Source code" link="https://github.com/texus/TGUI/archive/v1.12.1.zip" style="Green" %}

Precompiled libraries for Windows with SFML_GRAPHICS backend: (requires matching libraries from [SFML 3.1.0](https://www.sfml-dev.org/download/sfml/3.1.0/))

<table>
<tr>
  <td><p>{% include button.ext text="Visual C++ 17 (2022) - 32bit" link="https://github.com/texus/TGUI/releases/download/v1.12.1/TGUI-1.12.1-vc17-32bit-for-SFML-3.1.0.zip" style="Green DownloadBtnInTable" %}</p></td>
  <td><p>{% include button.ext text="Visual C++ 17 (2022) - 64bit" link="https://github.com/texus/TGUI/releases/download/v1.12.1/TGUI-1.12.1-vc17-64bit-for-SFML-3.1.0.zip" style="Green DownloadBtnInTable" %}</p></td>
</tr>
<tr>
  <td><p>{% include button.ext text="GCC 14.2.0 MinGW (UCRT) (POSIX) - 32bit" link="https://github.com/texus/TGUI/releases/download/v1.12.1/TGUI-1.12.1-mingw-14.2.0-32bit-for-SFML-3.1.0.zip" style="Green DownloadBtnInTable" %}</p></td>
  <td><p>{% include button.ext text="GCC 14.2.0 MinGW (UCRT) (POSIX) - 64bit" link="https://github.com/texus/TGUI/releases/download/v1.12.1/TGUI-1.12.1-mingw-14.2.0-64bit-for-SFML-3.1.0.zip" style="Green DownloadBtnInTable" %}</p></td>
</tr>
</table>
